...
class Room {
	...
	public:
		...
		*/
		...
		Reservation* getReservationAt(int, int) const;
		...
		*	@param Reservation* - reservation to be compared to all reservations in the room.
		*	@param int span of conflicts
		*	@param int& - count of all conflicted reservation
		*/
		Reservation*** getConflictedReservation(Reservation*, int&, int*&);	
		

/*********************************************************************************************************************/		

		Reservation** getAllReservationsAtDay(int, int&);
		
		int getReservationCountAtDay(int) const;
		
		bool conflictWithClass(Reservation*);
